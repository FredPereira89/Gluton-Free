...
// Rejudge after an owner removes a Listing, skipping the tier stability hold for this explicit change.
export const listingUndoTask = schemaTask({
  id: "owner-listing-undo",
  schema: z.object({
